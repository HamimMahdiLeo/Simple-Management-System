...
namespace HospitalManagement {
    ...
    public partial class HospitalDBDataSet1 : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public UsersRow AddUsersRow(string FullName, string DOB, string Gender, string BloodGroup, string Contact, string Category, string Username, string Password) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public UsersRow FindByUserIdUsername(int UserId, string Username) {
...
namespace HospitalManagement.HospitalDBDataSet1TableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Users] ([FullName], [DOB], [Gender], [BloodGroup], [Contact], [Category], [Username], [Password]) VALUES (@FullName, @DOB, @Gender, @BloodGroup, @Contact, @Category, @Username, @Password);
SELECT UserId, FullName, DOB, Gender, BloodGroup, Contact, Category, Username, Password FROM Users WHERE (UserId = SCOPE_IDENTITY()) AND (Username = @Username)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Users] SET [FullName] = @FullName, [DOB] = @DOB, [Gender] = @Gender, [BloodGroup] = @BloodGroup, [Contact] = @Contact, [Category] = @Category, [Username] = @Username, [Password] = @Password WHERE (([UserId] = @Original_UserId) AND ([FullName] = @Original_FullName) AND ([DOB] = @Original_DOB) AND ([Gender] = @Original_Gender) AND ([BloodGroup] = @Original_BloodGroup) AND ([Contact] = @Original_Contact) AND ([Category] = @Original_Category) AND ([Username] = @Original_Username) AND ([Password] = @Original_Password));
SELECT UserId, FullName, DOB, Gender, BloodGroup, Contact, Category, Username, Password FROM Users WHERE (UserId = @UserId) AND (Username = @Username)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::HospitalManagement.Properties.Settings.Default.HospitalDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT UserId, FullName, DOB, Gender, BloodGroup, Contact, Category, Username, Pa" +
                "ssword FROM dbo.Users";
        ...
        public virtual int Fill(HospitalDBDataSet1.UsersDataTable dataTable) {
        ...
        public virtual HospitalDBDataSet1.UsersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            HospitalDBDataSet1.UsersDataTable dataTable = new HospitalDBDataSet1.UsersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(HospitalDBDataSet1.UsersDataTable dataTable) {
        ...
        public virtual int Delete(int Original_UserId, string Original_FullName, string Original_DOB, string Original_Gender, string Original_BloodGroup, string Original_Contact, string Original_Category, string Original_Username, string Original_Password) {
        ...
        public virtual int Insert(string FullName, string DOB, string Gender, string BloodGroup, string Contact, string Category, string Username, string Password) {
            if ((FullName == null)) {
        ...
        public virtual int Update(
            ...
            if ((Original_BloodGroup == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[12].Value = ((string)(Original_BloodGroup));
            }
            if ((Original_Contact == null)) {
                throw new global::System.ArgumentNullException("Original_Contact");
            }
        ...
        public virtual int Update(
                    ...
                    string Original_Username, 
                    string Original_Password) {
            return this.Update(FullName, DOB, Gender, BloodGroup, Contact, Category, Original_Username, Password, Original_UserId, Original_FullName, Original_DOB, Original_Gender, Original_BloodGroup, Original_Contact, Original_Category, Original_Username, Original_Password, Original_UserId);
        }
    }
